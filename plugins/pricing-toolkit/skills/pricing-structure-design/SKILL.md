...
description: >-
  ...
  value is captured without the low price leaking to everyone: segment
  prices, good-better-best tiers, versioning, volume discounts, bundles,
  two-part tariffs, peak and off-peak or regional prices, student or loyalty
  discounts, and product-line price ladders. Use whenever someone asks
  whether to charge different customers different prices; how to structure
  plans or tiers and the gaps between them; why customers keep choosing the
  cheaper tier; what fences stop a discount leaking; whether a bundle or
  volume discount makes sense; how to diagnose a product line's price ladder
  and margins; how discounting erodes list-price margins; or the fairness and
  legal risks of personalised or dynamic pricing. Not for estimating
