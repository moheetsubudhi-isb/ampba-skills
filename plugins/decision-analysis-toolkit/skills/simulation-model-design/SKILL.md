...
description: >-
  Design, run and read a Monte Carlo simulation when a plan depends on several
  uncertain inputs. Use whenever someone asks for a risk or what-if model with
  ...
  optimisation of a production or allocation plan, and not for forecasting a
  time series.
---
